...
Initialize sinks and telemetry sources

Continuously gather telemetry data

Format and route messages to console/file
...
Logger-chan makes use of several design patterns:
...
Create a class inheriting ITelemetrySource

Implement openSource() and readSource()

Register in TelemetryApplication::setupTelemetrySources

Add a new sink type

Create a class implementing ILogSink

Override writeMessage(LogMessage&)

Update LogManagerBuilder/Factory
